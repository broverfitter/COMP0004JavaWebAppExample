        ...
        <tr>
            ...
            <td valign="top">
                ...
                <ul>
                    ...
                    %>
                                    <li>Directory: <%= dir.getName() %>
                                        <ul>
                                            ...
                                            %>
                                                        <li><a href="<%= note.getFpath() %>">Note: <%= note.getTitle() %> (Path: <%= note.getFpath() %>)</a></li>
                                            <%
                                                    }
                                                }
                                            %>
                    ...
                    %>
                                    <li>Note: <%= note.getTitle() %> (Path: <%= note.getFpath() %>)</li>
                    <%
                                }
                            }
                        }
            ...
            <td valign="top" style="padding-left:20px;">
                ...
                <form action="/savenote" method="post">
                    <textarea name="note" rows="10" cols="50" placeholder="Write your note here..."></textarea>
                    <br><br>
